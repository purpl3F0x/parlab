...
__global__ static void find_nearest_cluster(int     numCoords,
    ...
    // TODO: Copy deviceClusters to shmemClusters so they can be accessed faster. BEWARE: Make sure operations is complete before any thread continues...
...
void kmeans_gpu(double* objects,        /* in: [numObjs][numCoords] */
    ...
    /*	Define the shared memory needed per block.
        - BEWARE: We can overrun our shared memory here if there are too many clusters or too many coordinates!
    ...
    // TODO: Calculate the size of the shared memory needed per block
